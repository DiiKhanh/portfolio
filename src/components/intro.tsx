  ...
  return (
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0'>
      ...
      <motion.div className='flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium'
        ...
        <Link href='#contact'
          className='group px-7 py-3 rounded-full bg-gray-900 text-white flex items-center gap-2 outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition border border-black/10'
        >
          Contact me here{' '}<BsArrowRight className='opacity-70 group-hover:translate-x-1 transition' />
        </Link>
        <a href='/CV.pdf' className='group px-7 py-3 rounded-full bg-white flex items-center gap-2 outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10'
          download={true}
        >
